...
<!-- New SVG container for the grid and circle -->
<svg width={data.canvas.width} height={data.canvas.height} style="border: 1px solid #ccc;">
  <!-- Render grid and labels from the server -->
  {@html data.gridSvg}
  {@html data.labelsSvg}
