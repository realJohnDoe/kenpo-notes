<script lang="ts">
  ...
  const baseBtnClasses = 'w-8 h-8 md:w-12 md:h-12 rounded-lg flex justify-center items-center cursor-pointer shadow-md transition-all duration-200 ease-in-out hover:-translate-y-px hover:shadow-lg active:translate-y-0';
