<script lang="ts">
  ...
  const baseBtnClasses = 'w-12 h-12 rounded-lg bg-bg border border-border flex justify-center items-center cursor-pointer shadow-md transition-all duration-200 ease-in-out hover:bg-bg-dark hover:-translate-y-px hover:shadow-lg active:bg-gray-200 active:translate-y-0';
  const speedBtnClasses = 'text-sm font-medium';
    const activeSpeedBtnClasses = 'bg-primary text-bg-light hover:text-text hover:primary-muted';
</script>
